...
function HomeAdmin() {
  ...
  // console.log("App Thesis\t" + AllThesis.length);
  // console.log("Iot Thesis\t" + AllThesis.length);
  // console.log("Game Thesis\t" + AllThesis.length);
  // console.log("Teach Thesis\t" + AllThesis.length);
  // console.log("Other Thesis\t" + AllThesis.length);
        ...
        {/* <Row  className='mb-3'>
            <Col lg="3" sm="6">
              <Card>
                ...
                <Card.Footer className='text-right'>
                <Card.Text> Update Now </Card.Text>
                </Card.Footer>
              </Card>
            </Col>
